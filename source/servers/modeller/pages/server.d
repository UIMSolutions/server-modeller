module servers.modeller.pages.server;
...
/* static this() {
    serverModeller.pages("server", new class DH5APPPageController {
      this() { super(); }
...
<html lang="en">
  ...
  <body class="antialiased"> * /
    H5Div(["wrapper"], `<aside class="navbar fixed-top navbar-vertical navbar-expand-lg navbar-dark">
                    ...
                    <div class="card">
                      <div class="card-body p-2 text-center">
                        <div class="text-end text-green">
                          <span class="text-green d-inline-flex align-items-center lh-1">`~tablerIcon("trending-up")~`</span>
                        </div>
                      ...
                      <div class="card-body p-2 text-center">
                        <div class="text-end text-red">
                          <span class="text-red d-inline-flex align-items-center lh-1">
                            -2% `~tablerIcon("trending-down")~`</span>
                        </div>
                    ...
                    <div class="position-absolute top-0 left-0 px-3 mt-1 w-50">
                      <div class="row g-2">
                        ...
                        <div class="col">
                          ...
                          <div class="text-muted">`~tablerIcon("trending-up")~` +5% more than yesterday</div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-12">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-blue text-white avatar">`~tablerIcon("currency-dollar")~`</span>
                          </div>
                          <div class="col">
                  ...
                  <div class="col-12">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-green text-white avatar">`~tablerIcon("shopping-cart")~`</span>
                          </div>
                          <div class="col">
                            <div class="font-weight-medium">
                              78 Orders
                  ...
                  <div class="card-table table-responsive">
                    <table class="table table-vcenter">
                      ...
                      <tr>
                        <td>
                          /about.html
                          <a href="#" class="ms-1" aria-label="Open website">`~tablerIcon("link")~`</a>
                        </td>
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter">
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("check")~` 3/10</a>
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("message")~` 6</a>
                        </td>
                        <td>
                          <span class="avatar avatar-sm">JL</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap text-muted">`~tablerIcon("calendar")~` January 01, 2019
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("check")~` 0/6</a>
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("message")~` 1</a>
                        </td>
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url(./static/avatars/002m.jpg)"></span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("check")~` 6/10
                          </a>
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("message")~` 12</a>
                        </td>
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url(./static/avatars/003m.jpg)"></span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap text-muted">`~tablerIcon("calendar")~` January 01, 2019</td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("check")~` 3/7</a>
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("message")~` 5</a>
                        </td>
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url(./static/avatars/000f.jpg)"></span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("check")~` 2/9
                          </a>
                        </td>
                        <td class="text-nowrap">
                          <a href="#" class="text-muted">`~tablerIcon("message")~` 3</a>
                        </td>
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url(./static/avatars/001f.jpg)"></span>
                        </td>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      <thead>
                        <tr>
                          ...
                          <th class="w-1">No. `~tablerIcon("chevron-up")~`</th>
                  ...
                  <div class="card-footer d-flex align-items-center">
                    ...
                    <ul class="pagination m-0 ms-auto">
                      <li class="page-item disabled">
                        <a class="page-link" href="#" tabindex="-1" aria-disabled="true">`~tablerIcon("chevron-left")~` prev
                        </a>
                      </li>
